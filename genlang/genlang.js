...
function peg$parse(input, options) {
  ...
  var peg$e0 = peg$otherExpectation("rule_list");
  ...
  var peg$e11 = peg$classExpectation(["\"", "\\", "/", "b", "f", "n", "r", "t"], false, false);
  ...
  var peg$f3 = function(prob, elems) { 
  ...
  var peg$f4 = function(prob) { return { type: 'prob', prob }; };
  var peg$f5 = function(id) { return { type: 'ref', ref: id }; };
  var peg$f6 = function(str) { return { type: 'terminal', value: str }; };
  var peg$f7 = function(id) { return { type: 'terminal', value: id }; };
  var peg$f8 = function(expr) { return expr; };
  var peg$f9 = function(num) { return num; };
  var peg$f10 = function(chars) { return chars.join('').trim(); };
  var peg$f11 = function(chars) { return chars.join(''); };
  var peg$f12 = function(char) { 
      switch(char) {
        case 'b': return '\b';
        case 'f': return '\f';
        case 'n': return '\n';
  ...
  var peg$f14 = function(digits) { return parseInt(text(), 10); };
  var peg$currPos = 0;
  var peg$savedPos = 0;
