...
function peg$parse(input, options) {
  ...
  const peg$e10 = peg$classExpectation(["\"", "\\", "/", "b", "f", "n", "r", "t"], false, false, false);
  ...
  function peg$f4(elems) {    return elems;  }
  function peg$f5(prob) {    return { type: 'prob', prob };  }
  function peg$f6(id) {    return { type: 'ref', ref: id };  }
  function peg$f7(str) {    return { type: 'terminal', value: str };  }
  function peg$f8(id) {    return { type: 'terminal', value: id };  }
  function peg$f9(expr) {    return { type: 'expr', expr };  }
  function peg$f10(expr) {    return expr;  }
  function peg$f11(num) {    return num;  }
  ...
  function peg$f15(id) {    return text();  }
  function peg$f16(digits) {    return parseInt(text(), 10);  }
